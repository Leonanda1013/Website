...
<body>
    <?php
    include("koneksi.php"); // Memperbaiki tanda kutip
    $id = $_GET['id']; // Menggunakan 'id' dari URL dengan benar
    $query = "SELECT * FROM anggota WHERE id = $id"; // Memperbaiki kueri SQL
    ...
    <div class="container mt-4">
        ...
        <form action="proses.php?aksi=ubah" method="post"> <!-- Memperbaiki atribut action -->
